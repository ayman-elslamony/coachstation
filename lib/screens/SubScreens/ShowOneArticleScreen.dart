...
class ShowOneArticleScreen extends StatefulWidget {

  @override
  _ShowOneArticleScreenState createState() =>
      _ShowOneArticleScreenState();
}

class _ShowOneArticleScreenState
    extends State<ShowOneArticleScreen> {
